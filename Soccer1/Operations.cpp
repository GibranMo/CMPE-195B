...
//world def
int const screenW = 1200;
int const screenH = 760;
int const testNum = 88;
bool help = false;
...
void setUpTextures(){
    ...
    player1.tex = glTexImageTGAFile("dbz/dotBlackArrow.tga", 0, 0);
    player2.tex = glTexImageTGAFile("dbz/redTriangle.tga", 0, 0);
    
    someName.tex = glTexImageTGAFile("dbz/kroos.tga", 0, 0);
    someName.frameTime = 60;
...
void setUp(){
    ...
    setData(&someName, x, y-35, w, h, lives, velX, velY, isPlaying);

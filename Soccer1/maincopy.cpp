...
void testFunction()
{
    map <string, SPlayer*> myMap1;
    map <string, SPlayer*> myMap2;
    SPlayer p1 ("Ronaldo");
    SPlayer p2("Bale");
    SPlayer p3 ("Ramos");
    SPlayer p4("James");
    SPlayer p5 ("Dani Alves");
    SPlayer p6("Pique");
    SPlayer p7 ("Suarez");
    SPlayer p8("Messi");
    
    
    myMap1[p1.getName()] = &p1;
    myMap1[p2.getName()] = &p2;
    myMap1[p3.getName()] = &p3;
    myMap1[p4.getName()] = &p4;
    
    myMap2[p5.getName()] = &p5;
    myMap2[p6.getName()] = &p6;
    myMap2[p7.getName()] = &p7;
    myMap2[p8.getName()] = &p8;
...
int main(void)
{
    ...
    while (!quit) {
        ...
        if (playing){
            ...
            glDrawSprite2(player2.tex, player2.x, player2.y, player2.w, player2.h, a);
            //glDrawSprite(someName.tex, someName.x, someName.y, someName.w , someName.h);
